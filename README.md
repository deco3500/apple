...
Filter Bubble Proposal

Students		Edward Liao, Jesse Head, Chris Wilkinson
Course		DECO3500
Workshop		W02
Submission date	5th of September, 2016
...
Tags
References
Example Collaboration and Communication Warnings Log Entries
...
Often users have no knowledge that this is occurring, and rarely have the ability to alter this behaviour, to the frustration of some (Pariser, 2011). Some are aware that the news they receive are not representative of the wider world, but they have no other way in which to receive quality news content. As a user, you are effectively ‘trapped’ by the filter bubble. As this continues, there is a heightened lack of diversity in news sources, with ‘clickbait’ articles becoming the norm. Again, this is largely due to a push towards greater click through rates.
...
Trello and ZenHub for task management
...
Instead use camelcase (“fileName”) or underscores (“file_name”)
...
Final copies will be signified with: v1-01, v1-02
...
Social Software
Information Space
CSCW (Asynchronous distributed interaction).
...

Example Collaboration and Communication Warnings Log Entries
Team Member Name: James Franco
Date: 15/09/2016
Description:
James missed a meeting without a notifying the team.
Signatures/Initials:
Rogen, S. A.
Galifianakis, Z. J.
...
Date: 21/09/2016
Description:
James skipped a team meeting for the second time, this is the last notice before a supervisor is notified. 
Signatures/Initials:
Rogen, S. A.
Galifianakis, Z. J.
